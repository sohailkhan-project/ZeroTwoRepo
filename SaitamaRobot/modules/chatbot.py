...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API to give you interactive environment with Zero Two. Chat with her and make your chat more alive.
*Commands:* 
*Admins only:*
