#My Anime List Module by @TheRealPhoenixBot
...
from SaitamaRobot import OWNER_ID, MAL_CLIENT_ID, MAL_ACCESS_TOKEN, MAL_REFRESH_TOKEN, dispatcher
...
*Available commands:*
 - /MAL_A <anime>: returns information about the anime.
 - /MAL_M <manga>: returns information about the manga.
 """
...
ANIME_HANDLER = DisableAbleCommandHandler("MAL_A", search_anime)
MANGA_HANDLER = DisableAbleCommandHandler("MAL_M", search_manga)
